  ...
  return (
    <section className="home-section home-slogan">
        ...
        <main className="home-slogan-main">
          <h2>STAY LOW KEY</h2>
          <div className="home-slogan-main-parf">
            <h3>Lorem ipsum dolor sit</h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur id optio mollitia dolores facere a distinctio deserunt architecto nam, quisquam non, nobis neque, totam porro corporis odio tenetur amet necessitatibus?</p>
          </div>
        </main>
    </section>
  );
